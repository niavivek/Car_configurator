 ...
 * BuildAuto also exposes AutoServer class which helps in building auto from properties file, and
 * to get arraylist of all auto models and options of each option set of an auto.
 */
public final class BuildAuto extends ProxyAutomobile
		implements CreateAuto, EditThread, UpdateAuto, FixAuto, CustomizeAuto, AutoServer {
