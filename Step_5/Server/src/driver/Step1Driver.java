...
public class Step1Driver {
	...
	public static void main(String[] args) {
		...
		try
		{
		ford = file1.readData(1,"Ford_focus.txt", ford);
		prius = file1.readData(1,"Toyota_Prius.txt", prius);
		tesla = file1.readData(1,"Tesla_S.txt", tesla);
		tesla1 = file1.readData(2,"Toyota_prop.txt", tesla1);
	
		tesla1.printAll();
		file1.serialData(tesla1);
		tesla1 = file1.deserialData(tesla1.getName() +".dat");
		tesla1.printAll();
		}
