...
/*
 * This serves as a driver to instantiate the server socket class and pass the socket
 * to the client socket class and start the thread.
 */

import client.ClientDSC;
/**
 * DOCUMENTATION
 * VERSION 1.0
...
*/
public class AutoModelClient {
	public static void main(String[] args) throws IOException {
		boolean DEBUG = false;
		ClientDSC AutoSocket = null;
		String localHost = "";
		// get the local host
		try {
		...
		// pass the localhost to the clientsocket
		AutoSocket = new ClientDSC(localHost, 4445);
		AutoSocket.start();
		if (DEBUG)
