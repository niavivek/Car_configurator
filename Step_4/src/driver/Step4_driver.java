 ...
 *  makes the object lock separate for the 2 threads and using notify will not release the lock
 *  for the other object. So, a wait method with a time is introduced, so after the time, the condition
 *  is checked again to further proceed or wait.
 *  16. Notify or NotifyAll becomes irrelevant here due to the use of wait(1) in the condition
 ...
 *  to keep the values intact for both the threads.
 ...
 *  23. The methods of automobile class are synchronized to enable object locking
 * @author vivek
 *
 */
/*
...
public class Step4_driver{
	...
	public static void main(String[] args) {
		...
		t1.updateOptionPriceThread(2,valThread12, (float) 500.0);		

		// Comment the above 2 lines and uncomment the below 2 lines to see non-synchronized behavior.		
		//Non-synchronized method to change the option set name using threads
/*
		t1.updateOptionSetNameThread(3,4,valThread3);
		t1.updateOptionSetNameThread(4,4,valThread4);
		*/
